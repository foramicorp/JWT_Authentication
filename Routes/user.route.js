...
const { getAllUser, getUserById, signupUser, loginUser, refreshToken, logoutUser, forgotPassword, resetPassword, updateUser,  softDeleteUser, hardDeleteUser, restoreUser } = require("../Controllers/user.controller");
...
userRouter.get("/get-userbyid" ,extractUserId, getUserById);
